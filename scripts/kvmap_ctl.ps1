...
$path = "build\kvmap_root"

$imageStorePath = "MyKvMapApplicationV1"
$appTypeName = "KvMap"
...
if($Action -eq "Connect"){
    ...
    Connect-ServiceFabricCluster
    Resolve-ServiceFabricService -ServiceName "fabric:/${appTypeName}/${appTypeName}Service" -PartitionKindSingleton -ForceRefresh
